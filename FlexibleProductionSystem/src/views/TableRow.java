...
public class TableRow extends JPanel {
	...
	protected int width = MyFrame.WIDTH * 2 / 3;
	// 数据行高度
	public static final int normalHeight = MyFrame.HEIGHT / 25;
	// 表头数据行高度
	public static final int largerHeight = MyFrame.HEIGHT / 18;
	protected int height = normalHeight;

	protected int id;
	protected Object[] datas;
	protected int[] scales;

	protected Font normalFont = new Font("黑体", Font.PLAIN, 13);
	protected Font largerFont = new Font("黑体", Font.BOLD, 16);
	...
	protected boolean isPartTableHead=false;
	@Override
