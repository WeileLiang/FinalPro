 ...
 *
 */
public class JobshopInfoPanel extends JPanel {

	public static final int MARGIN_TOP = MyFrame.HEIGHT / 6;
	// 设备图片的空间宽度
	public static final int PHOTO_SPACE_WIDTH = MyFrame.WIDTH / 4;
...
//	private JComboBox comboBox;
	...
	public JobshopInfoPanel(Object[][] datas,String title) {
		this.title=title;
		this.datas=datas;
		initViews();
		measureAndLayout();
...
//				}
	...
	private void measureAndLayout() {
		...
		titleLabel.setBounds((MyFrame.WIDTH-titleLabel.getWidth())/2, (MARGIN_TOP-titleLabel.getHeight())/2,titleLabel.getWidth()	, titleLabel.getHeight());
		add(titleLabel);
...
//		add(comboBox);
	...
	private void initViews() {
		...
		titleLabel.setFont(new Font("黑体", Font.PLAIN, 33));
		titleLabel.setForeground(Color.WHITE);
		
		// 头像
		photo = new JLabel();
		icon = new ImageIcon(".\\image\\pic_shangdipan.png");
		photo.setIcon(icon);

		// 更改头像
		changePhotoBtn = new PressedButton("更改图片");
